...
interface TableElementProps {
    ...
    onClick?: (parameter: any) => void;
    showFileInput?: boolean;
    onFileChange?: (index: number, file: File | null) => void; // ✅ Se añadió `onFileChange` correctamente
}
                                    ...
                                    <Table.Cell>
                                        ...
                                        <FileInput
                                            ...
                                            onChange={(e) => {
                                                ...
                                                setFiles({ ...files, [rowIndex]: file });

                                                // ✅ Llamar a `onFileChange` para notificar el archivo subido
                                                if (onFileChange) {
                                                    onFileChange(rowIndex, file);
                                                }
                                            }}
                                        />
                                    </Table.Cell>
