                ...
                <div className="w-[450px] bg-gray-800  p-7 rounded-lg shadow-md">
                    <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
                        ...
                        <div className="sm:mx-auto sm:w-full sm:max-w-sm">
                            ...
                            <h2 className="mt-10 text-center text-2xl/9 font-bold tracking-tight text-gray-100">Inicio de sesión</h2>
                            <h3 className="text-center font-bold tracking-tight text-gray-300">Al mundo Oscuro</h3>
                        </div>
